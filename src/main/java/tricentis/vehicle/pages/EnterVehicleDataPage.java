...
public class EnterVehicleDataPage {
	...
	public void preencherAbaVehicleData() throws InterruptedException {
		try {
			...
			driver.findElement(By.xpath(
					"//label[contains(text(), 'Fuel Type')]/following-sibling::select//option[@value='default']"))
					.click();
			Thread.sleep(1000);
			...
			// Preencher payload
			driver.findElement(By.xpath("//label[contains(text(), 'Payload')]/following-sibling::input"))
					.sendKeys("250");
			Thread.sleep(1000);
	...
	public void preencherAbaInsurantData() throws InterruptedException {
		try {
			...
			driver.findElement(By
					.xpath("//label[contains(text(), 'Country')]/following-sibling::select//option[@value='default']"))
					.click();
			Thread.sleep(1000);
			...
			driver.findElement(By.xpath(
					"//label[contains(text(), 'Occupation')]/following-sibling::select//option[@value='default']"))
					.click();
			Thread.sleep(1000);
			...
			// Hobbies
			List<WebElement> hobbies = driver
					.findElements(By.xpath("//input[@name='Hobbies']/following-sibling::span"));
			int min = 1;
			int count = 1;
	...
	public void preencherAbaProductData() throws InterruptedException {
		try {
			...
			driver.findElement(By.xpath(
					"//label[contains(text(), 'Merit Rating')]/following-sibling::select//option[@value='default']"))
					.click();
			Thread.sleep(1000);
			...
			driver.findElement(By.xpath(
					"//label[contains(text(), 'Courtesy Car')]/following-sibling::select//option[@value='default']"))
					.click();
			Thread.sleep(1000);
	...
	public void validarEmailSuccess(String msg) throws InterruptedException {
		try {
			...
			Assert.assertTrue(driver.findElement(By.xpath("//h2[contains(text(), 'success')]")).getText().equalsIgnoreCase(msg));
			driver.quit();
		} catch (Exception e) {
			Assert.fail();
			driver.quit();
